...
const Partners = () => {
    return (
        <div>
            <h3 className="text-blue-700 text-3xl font-bold text-center mb-5">Meet Our Partners</h3>
            <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-3">
                <div>
                    <div>
                        <h3 className='text-blue-700 text-xl font-bold'>1.AMAZON</h3>
                    ...
                    <div>
                        <h3 className='text-blue-700 text-xl font-bold'>2.FACEBOOK</h3>
                        <p className='text-gray-600'>
                    ...
                    <div>
                        <h3 className='text-blue-700 text-xl font-bold'>3.MICROSOFT</h3>
                        <p className='text-gray-600'>
                    ...
                    <div>
                        <h3 className='text-blue-700 text-xl font-bold'>4.APPLE</h3>
                        <p className='text-gray-600'>
